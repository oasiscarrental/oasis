      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have a range of vehicles for you to choose from. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>OASIS <span>Vehicle Rental</span></h2>
      <p>We provide vehicles ranging from economy to luxury.</p>
    </div>
    <div class="row"> 
...
{  ?>
        ...
        <div class="testimonial-m">
            <div class="testimonial-img"> <img src="assets/images/testimonial-index.png" alt=""/> </div>
