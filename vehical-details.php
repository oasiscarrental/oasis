...
<title>OASIS | Vehicle Details</title>
<!--Bootstrap -->
...
<link rel="shortcut icon" href="assets/images/favicon-icon/icons8-car-40.png">
...
<section id="listing_img_slider">
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" width="600" height="600" ></div>
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" class="img-responsive" alt="image" width="600" height="600"></div>
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" class="img-responsive" alt="image" width="600" height="600"></div>
  <div><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" class="img-responsive"  alt="image" width="600" height="600"></div>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">LKR <?php echo htmlentities($result->PricePerDay);?></p>
