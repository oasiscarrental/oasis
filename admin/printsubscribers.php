...
<head>
	...
	<title>OASIS | Print Subscribers  </title>
...
<?php  
 ...
 {  
      ...
      $sql = "SELECT * FROM tblsubscribers ORDER BY id ASC";  
 ...
 {  
      ...
      $obj_pdf->SetTitle("OASIS Subscribers");  
      ...
      $content = '';  
      $content .= '  
     <h4 align="center">OASIS Subscriber List</h4><br /> 
