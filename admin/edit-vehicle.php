...
<head>
	...
	<title>OASIS | Admin Edit Vehicle Info</title>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2" >
													...
													<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%" style="font-size : 20px;">Save changes</button>
												</div>
											</div>
