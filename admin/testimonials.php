...
$msg="Testimonial Successfully Hidden From Homepage!";
}
...
$msg="Testimonial Successfully Displaying On Homepage!";
}
...
<head>
	...
	<title>OASIS | Manage testimonials   </title>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to display?')"> Display</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to hide?')"> Hide</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
